...
namespace GV {
	...
	void OpenGLTexture2D::update() {
		...
		bool isFloatData = false;
		{
			...
			GV_ASSERT_MSG(textureData, "Texture failed to load: {0}", m_path);
		}
		m_width = width;
		m_height = height;
		...
		if (!isCorrectFormat(m_settings.format, channels, m_path.c_str())) {
			GV_GFX_ERROR("Texture format not correct for texture {0}", m_path);
	...
	std::pair<uint32_t, uint32_t> TextureFormatToGLenum(TextureFormat& format, int channels) {
		...
		switch (format)
		{
		case GV::TextureFormat::RGBA:
			internalFormat = GL_RGBA8;
			m_dataFormat = GL_RGBA;
			break;
		case GV::TextureFormat::RGB:
			internalFormat = GL_RGB8;
			m_dataFormat = GL_RGB;
			break;
		case GV::TextureFormat::RG:
			internalFormat = GL_RG8;
			m_dataFormat = GL_RG;
			break;
		case GV::TextureFormat::R:
			internalFormat = GL_R8;
			m_dataFormat = GL_RED;
			break;
		case GV::TextureFormat::SRGB:
			GV_GFX_WARN("SRGBA Texture are currently not supported");
			internalFormat = GL_SRGB8;
			m_dataFormat = GL_SRGB;
			break;
		case GV::TextureFormat::SRGBA:
			GV_GFX_WARN("SRGBA Texture are currently not supported");
			internalFormat = GL_SRGB8_ALPHA8;
			m_dataFormat = GL_SRGB_ALPHA;
			break;
		case GV::TextureFormat::RGBA16F:
			internalFormat = GL_RGBA16F;
			m_dataFormat = GL_RGBA;
			break;
		case GV::TextureFormat::RGB16F:
			internalFormat = GL_RGB16F;
			m_dataFormat = GL_RGB;
			break;
		case GV::TextureFormat::RG16F:
			internalFormat = GL_RG16F;
			m_dataFormat = GL_RGB;
			break;
		case GV::TextureFormat::R16F:
			internalFormat = GL_R16F;
			m_dataFormat = GL_RGB;
			break;
		case GV::TextureFormat::RGBA32F:
			internalFormat = GL_RGBA32F;
			m_dataFormat = GL_RGBA;
			break;
		case GV::TextureFormat::RGB32F:
			internalFormat = GL_RGB32F;
			m_dataFormat = GL_RGB;
			break;
		case GV::TextureFormat::RG32F:
			internalFormat = GL_RG32F;
			m_dataFormat = GL_RG;
			break;
		case GV::TextureFormat::R32F:
			internalFormat = GL_R32F;
			m_dataFormat = GL_RED;
			break;
		//depth_stencil
		case GV::TextureFormat::Depth16:
			internalFormat = GL_DEPTH_COMPONENT16;
			m_dataFormat = GL_DEPTH_COMPONENT;
			break;
		case GV::TextureFormat::Depth24:
			internalFormat = GL_DEPTH_COMPONENT24;
			m_dataFormat = GL_DEPTH_COMPONENT;
			break;
		case GV::TextureFormat::Depth32:
			internalFormat = GL_DEPTH_COMPONENT32;
			m_dataFormat = GL_DEPTH_COMPONENT;
			break;
		case GV::TextureFormat::Depth32F:
			internalFormat = GL_DEPTH_COMPONENT32F;
			m_dataFormat = GL_DEPTH_COMPONENT;
			break;
		case GV::TextureFormat::Depth24_Stencil8:
			internalFormat = GL_DEPTH24_STENCIL8;
			m_dataFormat = GL_DEPTH_STENCIL;
			break;
		case GV::TextureFormat::Depth32F_Stencil8:
			internalFormat = GL_DEPTH32F_STENCIL8;
			m_dataFormat = GL_DEPTH_STENCIL;
			break;
		case GV::TextureFormat::Stencil8:
			internalFormat = GL_STENCIL_INDEX8;
			m_dataFormat = GL_STENCIL_INDEX;
			break;
		case GV::TextureFormat::Auto:
			switch (channels) {
			case 4:
